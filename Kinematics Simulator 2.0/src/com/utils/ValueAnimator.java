...
import com.eudycontreras.multithreading.managers.ThreadManager;
import com.eudycontreras.utilities.FXSpan.ISpan;
...
public class ValueAnimator implements Animator{
	...
	public ValueAnimator(ISpan duration, double from, double to, ValueWrapper update){
		this.update = update;
	...
	public ValueAnimator(ISpan duration, double from, double to){
		this.playTime = duration;
		this.fromValue = from;
		this.toValue = to;
		this.value = from;
