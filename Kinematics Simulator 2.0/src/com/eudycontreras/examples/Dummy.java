    ...
    private static Parent createDummy() {
        ...
        headNode.setOnMouseDragged(new EventHandler<MouseEvent>() {
            ...
            public void handle(MouseEvent event) {
                head.moveEndpoint(skeleton.sceneToLocal(event.getSceneX(), event.getSceneY()));
            }
        });
        ...
        for (int i=0; i<2; i++) {
            ...
            elbow.setOnMouseDragged(new EventHandler<MouseEvent>() {
                @Override
                public void handle(MouseEvent event) {
                    lowerArm.moveStartPoint(skeleton.sceneToLocal(event.getSceneX(), event.getSceneY()));
                }
            });
            ...
            hand.setOnMouseDragged(new EventHandler<MouseEvent>() {
                @Override
                public void handle(MouseEvent event) {
                    lowerArm.moveEndpoint(skeleton.sceneToLocal(event.getSceneX(), event.getSceneY()));
                }
            });
            ...
            knee.setOnMouseDragged(new EventHandler<MouseEvent>() {
                @Override
                public void handle(MouseEvent event) {
                    lowerLeg.moveStartPoint(skeleton.sceneToLocal(event.getSceneX(), event.getSceneY()));
                }
            });
            ...
            foot.setOnMouseDragged(new EventHandler<MouseEvent>() {
                @Override
                public void handle(MouseEvent event) {
                    lowerLeg.moveEndpoint(skeleton.sceneToLocal(event.getSceneX(), event.getSceneY()));
                }
            });
