...
public class FXRangeSlider extends Group {
	...
	public FXRangeSlider(double zoomLevel, double maxZoom, double minZoom, Type type){
		this(WIDTH,HEIGHT, zoomLevel, maxZoom, minZoom, type);
	}
    
    public FXRangeSlider(double width, double height, double zoomLevel, double maxZoom, double minZoom, Type type){
    	this.type = type;
    	createSlider();
    	addEventHandling();
