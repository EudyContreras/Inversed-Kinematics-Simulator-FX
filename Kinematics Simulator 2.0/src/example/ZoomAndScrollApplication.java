...
public class ZoomAndScrollApplication extends Application {
    ...
    public void start(Stage stage) {
    	...
    	double canvasWidth = 1200*4;
    	double canvasHeight = 1000*4;
    	
        Group group = new Group();

        // create canvas
        PannableCanvas canvas = new PannableCanvas(canvasWidth, canvasHeight);

        canvas.setTranslateX(-canvasWidth/4);
        canvas.setTranslateY(-canvasHeight/4);
