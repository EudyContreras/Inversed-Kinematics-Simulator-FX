...
public class BouncingBalls extends Application {
    ...
    public static int SPRITE_COUNT = 55;

    public static Point2D FORCE_WIND = new Point2D(0, 0);
    public static Point2D FORCE_GRAVITY = new Point2D(0, 6);

    public static double SPRITE_ACCELERATION_SCALE =1.5;
    public static double SPRITE_MAX_SPEED = 5;
