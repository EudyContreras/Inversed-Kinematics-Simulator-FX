...
import com.eudycontreras.transitions.TranslateHeadTransition;
...
public class Caterpillar extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        final Bone head = (Bone)caterpillar.getBones().get(0);
        ...
        background.setOnMousePressed(new EventHandler<MouseEvent>() {
            ...
            public void handle(MouseEvent mouseEvent) {
                final Point2D current = caterpillar.localToScene(head.getStartPoint());
    ...
    private static Skeleton createCaterpillar() {
        ...
        for (int i=0; i<45; i++) {
            final Bone bone = new Bone(20, -30, 30);
